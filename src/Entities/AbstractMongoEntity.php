...
/**
 * Class AbstractMongoEntity.
 *
 * @property ManagerInterface _modelsManager
 */
abstract class AbstractMongoEntity extends PhalconCollection implements Unserializable
{
    ...
    public static function findById($id)
    {
        if (!is_object($id)) {
            ...
            /** @var AbstractMongoEntity $collection */
    ...
    {
        throw new Exception('The summatory() method is not implemented in the new Mvc AbstractMongoEntity');
    }
     ...
     * {@inheritdoc}
     *
     * @param \AbstractMongoEntity $collection
     *
     * @return bool
     * @codingStandardsIgnoreStart
     */
